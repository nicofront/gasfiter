...
<html>
	<head>
		...
		<meta name="title" content="Gasfiteria Metropolitana 24hrs - Emegencias - Destapes - Arreglo de Calefont - Fugas - Urgencias">
		<meta name="description" content="Somos una empresa dedicada al rubro de la gasfitería.">
		<meta name="keywords" content="Gasfiteria, Destapes, Emergencias, Calefont, Fugas, Urgencias">
		<meta name="robots" content="index, follow">
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<meta name="language" content="Spanish">
		<meta name="author" content="www.letscode.cl">

		<!-- Basic -->

		<title>Gasfitería Metropolitana</title>	
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="gasfiteria.css">

		<!-- Skin CSS -->
		<link rel="stylesheet" href="css/skin-startup-agency.css"> 

		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="css/custom.css">
		
		<a href="https://api.whatsapp.com/send?phone=56984038643&amp;text=Hola%20Gasfiter%C3%ADa%20Metropolitana,%20quisiera%20comunicarme%20con%20ustedes." class="floatws" target="_blank">
		...
		<header id="header" class="header-effect-shrink" data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyChangeLogo': true, 'stickyStartAt': 30, 'stickyHeaderContainerHeight': 100}">
							...
							<div class="header-column">
								<div class="header-row">
									<div class="header-logo">
										<a href="#">
											<img src="img/logo2.png" class="img-fluid" width="250" height="auto" alt="" />
										</a>
									</div>
								</div>
							</div>
							<div class="header-column justify-content-end">
								<div class="header-row">
										...
										<div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li><a href="#home" class="nav-link active" data-hash data-hash-offset="70">Inicio</a></li>
													<li><a href="#aboutus" class="nav-link" data-hash data-hash-offset="255">Quiénes Somos</a></li>
													<li><a href="#team" class="nav-link" data-hash data-hash-offset="35">Equipo</a></li>
													<li><a href="#servicios" class="nav-link" data-hash data-hash-offset="120">Servicios</a></li>
													<li><a href="#ofrecemos" class="nav-link" data-hash data-hash-offset="120">Qué Ofrecemos</a></li>
													<li><a href="#footer" class="nav-link" data-hash data-hash-offset="70">Contactos</a></li>
									...
									<div class="feature-box feature-box-style-2 align-items-center ml-lg-4">
										<div class="feature-box-icon d-sm-inline-flex">
											<a href="tel:+56984038643" class="text-color-primary text-color-hover-secondary text-decoration-none font-weight-bold line-height-1 custom-font-size-1 pb-0" style="color: #0281d7 !important;">
												<img class="icon-animated" width="28" src="img/icons/phone.svg" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-primary text-color-hover-secondary position-relative bottom-3'}" />
											</a>
										</div>
										<div class="feature-box-info pl-0">
											<a href="#footer" data-hash data-hash-offset="70" class="nav-link text-color-tertiary text-color-hover-primary text-decoration-none font-weight-bold line-height-1 custom-font-size-3 p-0" style="color: #0281d7 !important;">
											Contacto</a>
										</div>
									</div>
									<button class="btn header-btn-collapse-nav ml-2" data-toggle="collapse" data-target=".header-nav-main nav">
			...
			<div role="main" class="main">
				...
				<section id="home" class="section section-with-shape-divider custom-bg-color-1 border-0 pt-0 m-0">
					...
					<div class="custom-section-svg pb-5 pb-md-0 mb-5 mb-md-0">
						<div class="custom-section-svg-background appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="2300"></div>
						...
						<div class="container mt-5 pt-5">
							<div class="row align-items-center pt-5 mt-5 mt-lg-0 pt-lg-0">
								<div class="col-lg-6">
									<h1 class="font-weight-bold text-8 mb-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">Gasfitería Metropolitana 24Hrs</h1>
									<h2 class="font-weight-medium text-7 mb-3 pb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400">Todo Santiago</h2>
									<p class="custom-font-secondary custom-font-size-1 mb-4 pb-2 appear-animation text-justify" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600">
										Ofrecemos todo tipo de soluciones referente a arreglos de gasfitería. 
										Tenemos un equipo especialista para usted en esta área de trabajo.</p>
									<!--a href="#servicios" class="nav-link btn btn-gradient text-3 font-weight-bold px-5 py-3 appear-animation" data-hash data-hash-offset="120" data-appear-animation="fadeInUpShorter">Ver Servicios</a-->
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-6 pb-sm-5 pb-lg-0 mb-5 mb-lg-0">
							<div class="custom-svg-wrapper-1 px-5">
								...
								<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.1, 'isInsideSVG': true, 'transition': true, 'transitionDuration': 2000}">
									<img src="img/circulo.png" class="img-fluid position-relative z-index-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1100" alt="" />
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">QUIENES SOMOS</span>
							<h2 class="font-weight-bold text-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Somos una empresa dedicada a la gasfitería.</h2>

							<p class="custom-font-size-2 font-weight-light pb-2 mb-4 appear-animation text-justify" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
								Creada con convicciones claras de un servicio de calidad y garantía al máximo, para la plena satisfacción de nuestros clientes. Contamos con técnicos calificados 
								en el área e instrumentación y herramientas especialmente adecuados para el cumplimiento oportuno de las necesidades de su hogar, empresa u oficina, estando siempre
								a su disposición, todos los días de la semana en el horario que usted necesite.
							</p>
							<a href="#footer" data-hash data-hash-offset="70" class="btn btn-gradient text-3 font-weight-bold px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Contáctenos</a>
						</div>
					</div>
				</div>
				...
				<section id="team" class="section section-with-shape-divider custom-bg-color-1 border-0 m-0">
					...
					<div class="container pt-md-5 pb-1 pb-sm-5 my-5">
						<div class="row justify-content-center pt-5">
							<div class="col-lg-10 text-center">
								<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 d-block mb-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">NUESTRO TEAM</span>
								<h2 class="font-weight-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Somos Profesionales</h2>
								<!--p class="custom-font-size-2 font-weight-light appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p-->
							</div>
						</div>
						<div class="row mb-5 mb-lg-0">
							<div class="col">
								<div class="custom-svg-wrapper-2">
									...
									<div class="owl-carousel custom-dots-style-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800" data-plugin-options="{'responsive': {'0': {'items': 2}, '476': {'items': 2}, '768': {'items': 3}, '992': {'items': 3}, '1200': {'items': 4}}, 'autoplay': false, 'autoplayTimeout': 5000, 'autoplayHoverPause': true, 'dots': false, 'nav': false, 'loop': false, 'margin': 30, 'stagePadding': 15}">
										<div>
													...
													<div class="card-body p-3">
														<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
															<div class="thumb-info-wrapper">
																<img src="img/author-1.jpg" class="img-fluid" alt="Ignacio Garrido" />
															</div>
														</div>
														<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Ignacio Garrido</h3>
														<p class="text-center text-color-grey text-3 mb-2">Gásfiter</p>
													</div>
												</div>
											</a>
										</div>
											...
											<a href="#" class="text-decoration-none">
												<div class="card custom-card-style-1 box-shadow-4 my-3">
													<div class="card-body p-3">
														<div class="thumb-info thumb-info-hide-wrapper-bg mb-3 pb-2">
															<div class="thumb-info-wrapper">
																<img src="img/author-2.jpg" class="img-fluid" alt="Osvaldo Aguila" />
															</div>
														</div>
														<h3 class="text-center font-weight-bold text-capitalize line-height-1 text-5 text-color-hover-primary mb-0">Osvaldo Aguila</h3>
														<p class="text-center text-color-grey text-3 mb-2">Gásfiter</p>
													</div>
												</div>
											</a>
				...
				<section id="servicios" class="section section-with-shape-divider bg-secondary border-0 m-0">
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-10 text-center">
								<span class="d-block text-color-grey positive-ls-2 font-weight-normal custom-font-size-2 text-color-light opacity-6 mb-1">NUESTRO TRABAJO</span>
								<h2 class="font-weight-bold text-color-light text-10 mb-4">Servicios Ofrecidos</h2>
                                    ...
                                    <div id="portfolioLoadMoreWrapper" class="row row-gutter-sm portfolio-list sort-destination overflow-visible justify-content-center" data-sort-id="portfolio" data-total-pages="3" data-ajax-url="ajax/demo-it-services-ajax-load-more-">
                                            ...
                                            <div class="card border-0 custom-box-shadow-1 minh2 p-1">
                                                <div class="card-body">
                                                    <a href="javascript:;" class="text-decoration-none">
                                                        <img class="img-fluid pb-2 mb-4" src="img/calefont.jpg" alt="Arreglo Calefont">
                                                    </a>
                                                    <h4 class="font-weight-bold text-color-dark custom-text-size-2 mb-3"><a href="javascript:;" class="text-color-dark text-decoration-none">ARREGLO DE CALEFONT</a></h4>
                                                    <p class="custom-font-secondary custom-text-size-1 mb-1 text-justify">
														Si tiene problemas con su calefont, o necesita instalar uno nuevo contamos con técnicos calificados y autorizados SEC que revisan y 
														reparan calefonts <strong class="text-color-dark">Junkers, Neckar, Splendid, Mademsa, Trotter, entre otras</strong> marcas nacionales e importadas.
													</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 pb-1 mb-3  mr-3 ml-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
                                            <div class="card border-0 custom-box-shadow-1 minh2 p-1">
                                                <div class="card-body">
                                                    <a href="javascript:;" class="text-decoration-none">
                                                        <img class="img-fluid pb-2 mb-4" src="img/canerias.jpg" alt="Cañerías">
                                                    </a>
                                                    <h4 class="font-weight-bold text-color-dark custom-text-size-2 mb-3"><a href="javascript:;" class="text-color-dark text-decoration-none">CAÑERÍAS</a></h4>
                                                    <p class="custom-font-secondary custom-text-size-1 mb-1 text-justify">
													Con el paso del tiempo las cañerías se desgastan se fatigan y en algún momento se rompen nosotros reparamos todo tipo de cañerías tanto como de 
													<strong class="text-color-dark">red de agua , desagües y gas</strong>. reparamos y arreglamos cañerías tipo pex -ppr -fierro fundió - cobre -pvc , hidráulico y sanitario.
													</p>
                                                </div>
                                            </div>
										</div>
										...
										<div class="col-lg-3 col-md-3 pb-1 mb-3  mr-3 ml-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1100">
                                            <div class="card border-0 custom-box-shadow-1 minh2 p-1">
                                                <div class="card-body">
                                                    <a href="javascript:;" class="text-decoration-none">
                                                        <img class="img-fluid pb-2 mb-4" src="img/destapes.jpg" alt="Destapes">
                                                    </a>
                                                    <h4 class="font-weight-bold text-color-dark custom-text-size-2 mb-3"><a href="javascript:;" class="text-color-dark text-decoration-none">DESTAPES</a></h4>
                                                    <p class="custom-font-secondary custom-text-size-1 mb-1 text-justify">
														Destapes de desagües, cámaras de alcantarillado, vertical de edificios, lavaplatos, wc, lavamanos, tinas, ductos de aguas lluvias, desagües, piletas,
														urinarios, Nuestras máquinas no causan daños en tuberías ni desagues logrando limpiarlas sin ningùn riesgo.
													</p>
                                                </div>
                                            </div>
										</div>
                                    ...
                                    <div id="portfolioLoadMoreWrapper" class="row row-gutter-sm portfolio-list sort-destination overflow-visible justify-content-center" data-sort-id="portfolio" data-total-pages="3" data-ajax-url="ajax/demo-it-services-ajax-load-more-">
                                        <div class="col-lg-3 col-md-3 pb-1 mb-3  mr-3 ml-3 purchaseappear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">
                                            <div class="card border-0 custom-box-shadow-1 minh p-1">
                                                <div class="card-body">
                                                    <a href="javascript:;" class="text-decoration-none">
                                                        <img class="img-fluid pb-2 mb-4" src="img/fugas.jpg" alt="Fugas">
                                                    </a>
                                                    <h4 class="font-weight-bold text-color-dark custom-text-size-2 mb-3"><a href="javascript:;" class="text-color-dark text-decoration-none">FUGAS</a></h4>
                                                    <p class="custom-font-secondary custom-text-size-1 mb-1 text-justify">
														Todas las soluciones que usted requiere ante cualquier tipo de fugas ya sean de <strong class="text-color-dark">agua o gas, filtraciones o gasfitería</strong>.
													</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 pb-1 mb-3  mr-3 ml-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
                                            <div class="card border-0 custom-box-shadow-1 minh p-1">
                                                <div class="card-body">
                                                    <a href="javascript:;" class="text-decoration-none">
                                                        <img class="img-fluid pb-2 mb-4" src="img/griferia.jpg" alt="Grifería y artefactos">
                                                    </a>
                                                    <h4 class="font-weight-bold text-color-dark custom-text-size-2 mb-3"><a href="javascript:;" class="text-color-dark text-decoration-none">CAMBIO DE GRIFERÍA Y ARTEFACTOS</a></h4>
                                                    <p class="custom-font-secondary custom-text-size-1 mb-1 text-justify">
														Cambiamos todo tipo de griferías y artefactos adaptados y hermoseamos su <strong class="text-color-dark">baño , cocina , quincho y lavadero</strong>.
													</p>
                                                </div>
                                            </div>
										</div>
										...
										<div class="col-lg-3 col-md-3 pb-1 mb-3 mr-3 ml-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1300">
                                            <div class="card border-0 custom-box-shadow-1 minh p-1">
                                                <div class="card-body">
                                                    <a href="javascript:;" class="text-decoration-none">
                                                        <img class="img-fluid pb-2 mb-4" src="img/urgencias.jpg" alt="Urgencias">
                                                    </a>
                                                    <h4 class="font-weight-bold text-color-dark custom-text-size-2 mb-3"><a href="javascript:;" class="text-color-dark text-decoration-none">URGENCIAS</a></h4>
                                                    <p class="custom-font-secondary custom-text-size-1 mb-1 text-justify">
														Los problemas en la gasfiteria llegan cuando uno menos los espera. en nuestra empresa <strong class="text-color-dark">atendemos las 24 horas</strong>, no dude en llamarnos.
													</p>
                                                </div>
                                            </div>
										</div>
				...
				<div class="container mt-4 mb-5">
					<div id="ctrabajamos" class="row justify-content-center">
						<div class="col-lg-10 text-center">
							<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 d-block appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">COMO TRABAJAMOS</span>
							<h2 class="font-weight-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Proceso del Servicio</h2>
					...
					<div class="custom-svg-wrapper-3">
						...
						<div class="row">
							<div class="col-lg-4 col-md-4" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
								<div class="service-process-layout1">
									<div class="image-box text-center">
										<img src="img/contactoicono.png" alt="service-image">
									</div>
									<div class="content-box text-center">
										<h3 style="margin-top:30px; "><a href="javascript:;" style="text-decoration:none !important;">Visita Gratis</a></h3>
										
									</div>
								</div>  
							</div>
							<div class="col-lg-4 col-md-4" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">
								<div class="service-process-layout1">
									<div class="image-box text-center">
										<img src="img/autoicono.png" alt="service-image">
									</div>
									<div class="content-box text-center">
									<h3 style="margin-top:30px; "><a href="javascript:;" style="text-decoration:none !important;">Vamos a su domicilio</a></h3>
										
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-md-4" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
								<div class="service-process-layout1">
									<div class="image-box text-center">
										<img src="img/arregloicono.png" alt="service-image">
									</div>
									<div class="content-box text-center">
										<h3 style="margin-top:30px; "><a href="javascript:;" style="text-decoration:none !important;">Resolvermos su problema</a></h3>
			...
			<section id="ofrecemos" class="section section-with-shape-divider custom-bg-color-1 border-0 m-0">
					...
					<div class="container pt-2 pt-md-5 pb-1 pb-md-5 mt-5 mb-5 mb-lg-0 mb-xl-5">
						<div class="row pb-2 mt-5 mb-5">
							<div class="col text-center">
								<span class="text-color-grey positive-ls-2 font-weight-medium custom-font-size-2 d-block appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">GARANTÍAS Y MAS</span>
								<h2 class="font-weight-bold text-10 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400">Que Ofrecemos</h2>
							</div>
						</div>
						...
						<div class="featured-boxes featured-boxes-style-3">
							<div class="row">
								<div class="col-lg-3">
									<div class="featured-box featured-box-primary featured-box-effect-3" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
										<div class="box-content">
											<i class="icon-featured fas fa-exclamation-circle top-0"></i>
											<h4 class="font-weight-normal text-5 mt-3">Servicio <strong class="font-weight-extra-bold">Emergencia</strong></h4>
										</div>
									</div>
								</div>
								<div class="col-lg-3">
									<div class="featured-box featured-box-quaternary featured-box-effect-3" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900">
										<div class="box-content">
											<i class="icon-featured fas fa-thumbs-up top-0"></i>
											<h4 class="font-weight-normal text-5 mt-3">Trabajo <strong class="font-weight-extra-bold">Garantizado</strong></h4>
										</div>
									</div>
								</div>
								<div class="col-lg-3">
									<div class="featured-box featured-box-primary featured-box-effect-3" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">
										<div class="box-content">
											<i class="icon-featured fas fa-shipping-fast top-0"></i>
											<h4 class="font-weight-normal text-5 mt-3">Servicio <strong class="font-weight-extra-bold">Rápido</strong> </h4>
										</div>
									</div>
								</div>
								<div class="col-lg-3">
									<div class="featured-box featured-box-quaternary featured-box-effect-3" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1500">
										<div class="box-content">
											<i class="icon-featured fas fa-hand-holding-usd top-0"></i>
											<h4 class="font-weight-normal text-5 mt-3">Precios <strong class="font-weight-extra-bold">Asequibles</strong></h4>
										</div>
									</div>
								</div>
							</div>
